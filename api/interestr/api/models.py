...
class Comment(BaseModel):
    owner = models.ForeignKey(auth_models.User, related_name="comments", default=None, null=True)
    text = models.TextField(default='')
    post = models.ForeignKey(Post, related_name='comments', on_delete=models.CASCADE, default=None, null=True)
